...
class Java extends Common implements TechnologiesInterface, Serializable{
    def stepList = [];
    ...
    final StepModel[] ciSteps = [
        ...
        [
            ...
            urlRepo: 'https://github.com/febarbosa182/pipestep-dependencies-java.git',
            branch: 'v1.0.0',
        ...
        [
            identifier: 'build',
            stepName: 'Build',
            urlRepo: 'https://github.com/febarbosa182/pipestep-build-java.git',
            branch: 'v1.0.0',
